...
## A UX AUTHORITY AND ENGINEER, FOR DEFENDING THE INTERNET
...
## Compensation:
Fight for the Future offers a competitive salary and benefits package and salary is commensurate with experience. Benefits include full health care, partially covered dental benefits, a 401K plan, and paid sick, vacation, and federal holidays days. We offer support for remote work, training and mentoring, and a driven, highly collaborative, supportive work environment. We’d like to start working with you on a contract basis at an hourly rate, but we will be able to offer full-time position with competitive salary and benefits to the right person and can discuss what you are looking for during the interview process.
